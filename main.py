...
# 2) GrabCut ile kaba ön plan maskesini elde etme
...
# 3) Morfolojik kapanışla deliği kapatma
kernel = cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (5,5))
mask2 = cv2.morphologyEx(mask2, cv2.MORPH_CLOSE, kernel, iterations=3)

# 4) Bağlı bileşenleri bulma, sadece geniş yatay bileşenleri seçme
